...
export const faqItems = [
  { q: 'How does the AI Wealth Advisor work?', a: 'Our AI Wealth Advisor uses advanced machine learning models trained on decades of market data, combining fundamental analysis, technical signals, macroeconomic indicators, and alternative data to provide personalized investment recommendations tailored to your risk profile and goals.' },
  { q: 'Is my financial data secure?', a: 'Absolutely. We use bank-grade 256-bit AES encryption for all data at rest and in transit. We are SOC 2 Type II certified and comply with all applicable financial data regulations including GDPR and CCPA. We never sell your data.' },
  { q: 'How accurate are the opportunity scores?', a: 'Our Opportunity Scoring algorithm has been backtested across 15 years of market data and achieves a 73% directional accuracy rate over a 90-day horizon. Scores above 80 have historically delivered 2.1x the market return on average.' },
  { q: 'Can I connect my existing brokerage accounts?', a: 'Yes, we support direct integration with 50+ brokerages including Schwab, Fidelity, Interactive Brokers, TD Ameritrade, and Robinhood via secure read-only API connections. Your account credentials are never stored on our servers.' },
  { q: 'What is the Research Marketplace?', a: 'The Research Marketplace is a curated platform where top analysts, fund managers, and investment researchers publish their best ideas and reports. All analysts are vetted for track record. You can purchase individual reports or subscribe for unlimited access.' },
  { q: 'Do you offer a free trial?', a: 'Yes, all paid plans include a 14-day free trial with full feature access and no credit card required. We also offer a free Starter tier with limited features for users who want to explore the platform.' },
  { q: 'How does portfolio benchmarking work?', a: 'Your portfolio is automatically benchmarked against relevant indices (S&P 500, Russell 2000, MSCI World, etc.) based on your asset allocation. Risk-adjusted returns (Sharpe ratio, Sortino ratio) are calculated daily and displayed in your analytics dashboard.' },
  { q: 'Can I use ValueUnlocked for business analysis?', a: 'Yes, our Business Intelligence module supports company valuation, competitive analysis, market sizing, and due diligence workflows. It is particularly popular with M&A advisors, PE analysts, and strategic consultants.' },
];
