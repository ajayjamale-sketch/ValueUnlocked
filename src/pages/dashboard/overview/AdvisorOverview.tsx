...
export default function AdvisorOverview() {
  ...
  return (
    <div className="space-y-6">
      ...
      {selectedClient && (
        <div className="fixed inset-0 z-50 bg-black/60 flex items-start sm:items-center justify-center p-4 pt-24 pb-8 overflow-y-auto" onClick={() => setSelectedClient(null)}>
